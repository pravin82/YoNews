...
public class Tech_news extends AppCompatActivity implements LoaderCallbacks<List<News>> {
    public static final String LOG_TAG = MainActivity.class.getName();
    private TextView pEmptyTextView;
    private static final int EARTHQUAKE_LOADER_ID = 1;
    private NewsAdapter pAdapter;

    public static final String STRING_URL ="https://newsapi.org/v1/articles?source=techcrunch&apiKey=c230d4deb92d48d9b3e34e429e252a0c";
